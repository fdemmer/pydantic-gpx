# TODO needs license: https://gist.github.com/yu-ichiro/ded4d704316a3b986b006467557850a4
# TODO needs changes for pydantic 2
...
class RFC3986Regex:
    ...
    DEC_OCTET_5: Pattern = r"25[0-5]"  # 250-255
    DEC_OCTET: Pattern = (
    ...
    GEN_DELIMS: Pattern = r"[:/?#\\\[\]@]"
    SUB_DELIMS: Pattern = r"[!\$&'\(\)\*\+\,;=]"
